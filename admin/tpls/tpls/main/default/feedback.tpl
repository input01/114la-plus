...
<link href="/feedback/images/style.css" rel="stylesheet" type="text/css" />
<script language="javascript" type="text/javascript" src="/feedback/images/jquery.js"></script>
<script language="javascript" type="text/javascript" src="/feedback/images/feedback.js"></script>
</head>
<body>
<div class="wrap">
    <div id="header">
