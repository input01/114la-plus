...
<div id="page" class="container">
        ...
        <div class="con clearfix">
            ...
            <div class="searchform">
                <form id="searchForm" action="http://115.com/s" method="get" target="_blank">
                    <a class="label" href="http://115.com"><img width="105" height="35" alt="115聚搜" src="/static/images/s/115.gif"></a>
    ...
    <div class="guide clearfix"><span class="location"><strong>您当前的位置：</strong><a href="/" target="_parent">导航首页</a> &raquo; <span>友情连接</span></span>
    <span class="meta"><a href="/feedback/" class="feedback">留言反馈</a><a href="#"  class="sethome" target="_parent">设为主页</a></span></div>
