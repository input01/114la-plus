...
<style>
<!--
body { background:#3C7FAF url(/satatic/images/bd_bg.png) repeat-x top; margin:0; font:12px Verdana; color:#07519A; }
...
#footer .link { width:510px; line-height:22px; margin:auto; background:url(/static/images/sitem_bg.gif) repeat-x bottom; }
#footer .hr {
...
<div class="con">
    <h3>如果您希望<a href="/" target="_blank"><{$sysname}></a> 收录您的网站，贵站需要满足以下条件（即收录原则）： </h3>
...
&nbsp;&nbsp;&nbsp;&nbsp; 一些购物类网站等盈利性站点，请直接联系本站客服进行广告服务咨询。我们将为您提供最佳广告位！
  ...
  <form action="/url-submit/" method="post" onSubmit="return Validator.Validate(this,3)" name='siteadd' id="siteadd">
  ...
  <tr>
    <th>首页地址：</th>
    <td><input name="input" type="text" onclick="copyToClipBoard(this.value)" value="/" class="urltxt" /></td>
  </tr>
  <tr>
    <th>Logo地址：</th>
    <td><input name="input2" type="text" class="urltxt" id="input2" onclick="copyToClipBoard(this.value)" value="/logo.gif" /></td>
  </tr>
...
<div id="footer"> <a href="#" target="_blank">关于本站</a> | <a href="/url-submit/" target="_blank">免费收录</a> | <a href="/feedback" target="_blank">意见反馈</a>
            <div class="hr"></div>
